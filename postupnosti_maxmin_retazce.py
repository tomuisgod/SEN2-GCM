    ...
    def med(postupn_C):
        dlzka_postupn = len(postupn_C)

        if dlzka_postupn % 2 == 0:
            med1 = postupn_C[dlzka_postupn // 2]
            med2 = postupn_C[dlzka_postupn // 2 - 1]
            med = (med1 + med2) / 2
        else:
            med = postupn_C[dlzka_postupn//2]
    ...
    print("Medián postupnosti C: ", med_C)
